...
public class ${className}UserFaceDetectImageRsp extends ${className}BaseRsp implements Serializable{


	private static final long serialVersionUID = -8908048393907337977L;
