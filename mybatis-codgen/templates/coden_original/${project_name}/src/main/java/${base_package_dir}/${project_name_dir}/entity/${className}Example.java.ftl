...
import cn.com.sinaif.framework.core.mybatis.Criterion;

public class ${className}Example {
    protected String orderByClause;

    protected String paginationByLimit;

    protected boolean distinct;

    protected List<Criteria> oredCriteria;

    protected String paginationTableName;
    ...
    public String getPaginationTableName() {
        return paginationTableName;
    }

    public void setPaginationTableName(String paginationTableName) {
        this.paginationTableName = paginationTableName;
    }

    public void setPaginationByLimit(String paginationByLimit) {
        this.paginationByLimit = paginationByLimit;
    }

    public String getPaginationByLimit() {
         return paginationByLimit;
    }
