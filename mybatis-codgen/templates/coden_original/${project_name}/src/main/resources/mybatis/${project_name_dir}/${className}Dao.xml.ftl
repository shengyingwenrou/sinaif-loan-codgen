...
<mapper namespace="${base_package}.${project_name}.dao.${className}Dao">
    ...
    <!-- 根据ExampleFromTableName查找 -->
    <select id="selectListByExampleFromTableName" resultMap="BaseResultMap" parameterType="${base_package}.${project_name}.entity.${className}Example">
        select
        <include refid="Base_Column_List" />
        from ${r"${"}paginationTableName}
        <if test="_parameter != null">
            <include refid="Example_Where_Clause" />
        </if>
        <if test="orderByClause != null">
    ...
    <!-- 插入 -->
    <insert id="insert" parameterType="${base_package}.${project_name}.entity.${className}" keyProperty="id" useGeneratedKeys="true">
    ...
    <!-- 选择插入 -->
    <insert id="insertSelective" parameterType="${base_package}.${project_name}.entity.${className}" keyProperty="id" useGeneratedKeys="true">
        insert into ${table.sqlName}
